  ...
  _createClass(ImageItem, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          imagePlaceholder = _this$props4.imagePlaceholder,
          radius = _this$props4.radius,
          getItemRef = _this$props4.getItemRef;
      ...
      if (!image) {
        if (imagePlaceholder) {
          customStyle.backgroundImage = "url(".concat(imagePlaceholder, ")");
        }
      } else {
      ...
      return _react.default.createElement("div", {
        ref: getItemRef,
        className: (0, _classnames.default)(className, 'rpg-image-item-wrapper', {
